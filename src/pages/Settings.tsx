    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      <div>
        ...
        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1">
          Customize language, default currency, dark theme, and proactive alerts.
        </p>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setLocalSettings({ ...localSettings, language: e.target.value as LanguageCode })
                }
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setLocalSettings({ ...localSettings, currency: e.target.value as CurrencyCode })
                }
                className="w-full px-4 py-3 rounded-xl border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white text-sm font-semibold focus:ring-2 focus:ring-emerald-500 focus:outline-none"
              >
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400">
                All goal amounts & reports convert dynamically to {localSettings.currency}.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 rounded-3xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm space-y-6">
          ...
          <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-bold text-sm text-slate-900 dark:text-white">{t('darkMode')}</h4>
                <p className="text-xs text-slate-500 dark:text-slate-400">High-contrast dark color palette for evening use.</p>
              </div>
            </div>
        ...
        <div className="p-6 rounded-3xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800">
              <div>
                <h4 className="font-bold text-sm text-slate-900 dark:text-white">{t('overspendingAlerts')}</h4>
              ...
              <input
                ...
                onChange={(e) => setLocalSettings({ ...localSettings, alertOverspending: e.target.checked })}
            ...
            <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800">
              <div>
                <h4 className="font-bold text-sm text-slate-900 dark:text-white">{t('goalAlerts')}</h4>
                <p className="text-xs text-slate-500 dark:text-slate-400">
              ...
              <input
                ...
                onChange={(e) => setLocalSettings({ ...localSettings, alertGoalMilestones: e.target.checked })}
                className="w-5 h-5 rounded text-emerald-600 focus:ring-emerald-500"
              />
            </div>
          </div>
