...
- Name: Settings.spec.ts >> Settings Page Workflows >> handles data reset trigger correctly and reloads page
...
Call log:
  - waiting for getByRole('button', { name: /Reset All Data to Sample Defaults/i })
