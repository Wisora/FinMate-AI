...
- Name: Navbar.spec.ts >> Navbar Component & Navigation >> navigates to selected sections when navigation options are clicked
- Location: tests\Navbar.spec.ts:18:7
...
Call log:
  - waiting for getByRole('button', { name: /reports/i })
