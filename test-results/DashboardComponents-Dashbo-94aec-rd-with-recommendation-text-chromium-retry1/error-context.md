...
- Name: DashboardComponents.spec.ts >> Dashboard UI Components >> renders RecommendationCard with recommendation text
- Location: tests\DashboardComponents.spec.ts:21:7
...
Locator: getByText(/cut down on dining out/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/cut down on dining out/i)
