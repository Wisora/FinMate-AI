...
- Name: visual.spec.ts >> Visual Regression Snapshot Tests >> upgrade plan options visual snapshot
- Location: tests\visual.spec.ts:29:7

# Error details

```
Error: A snapshot doesn't exist at C:\Users\Craig A\Desktop\finmate-ai\tests\visual.spec.ts-snapshots\upgrade-page-chromium-win32.png, writing actual.
```
