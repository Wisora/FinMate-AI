...
- Name: visual.spec.ts >> Visual Regression Snapshot Tests >> landing page visual snapshot
- Location: tests\visual.spec.ts:4:7

# Error details

```
Error: A snapshot doesn't exist at C:\Users\Craig A\Desktop\finmate-ai\tests\visual.spec.ts-snapshots\landing-page-chromium-win32.png, writing actual.
```
