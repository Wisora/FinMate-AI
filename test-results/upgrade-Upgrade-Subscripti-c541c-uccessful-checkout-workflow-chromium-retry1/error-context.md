...
- Name: upgrade.spec.ts >> Upgrade & Subscription Checkout Workflows >> simulates successful checkout workflow
- Location: tests\upgrade.spec.ts:35:7
...
Call log:
  - waiting for getByRole('button', { name: /Upgrade to Pro Now →/i })
