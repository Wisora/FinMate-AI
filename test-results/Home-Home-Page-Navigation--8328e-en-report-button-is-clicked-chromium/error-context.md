...
- Name: Home.spec.ts >> Home Page & Navigation Workflows >> navigates to reports when report button is clicked
...
Call log:
  - waiting for getByRole('button', { name: /View Financial Reports/i })
