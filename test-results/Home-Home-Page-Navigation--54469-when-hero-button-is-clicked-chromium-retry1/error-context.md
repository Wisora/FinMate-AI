...
- Name: Home.spec.ts >> Home Page & Navigation Workflows >> navigates to financial dashboard when hero button is clicked
...
Call log:
  - waiting for getByRole('button', { name: /Go to Financial Dashboard/i })
