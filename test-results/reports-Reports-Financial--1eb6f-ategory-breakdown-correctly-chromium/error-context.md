...
- Name: reports.spec.ts >> Reports & Financial Analytics Page Workflows >> renders KPI metrics and category breakdown correctly
- Location: tests\reports.spec.ts:35:7
...
Locator: getByText('Financial Analytics & Reports')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Financial Analytics & Reports')
