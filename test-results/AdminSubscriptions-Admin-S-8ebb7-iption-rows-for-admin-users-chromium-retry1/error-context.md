...
- Name: AdminSubscriptions.spec.ts >> Admin Subscriptions Page >> fetches and renders subscription rows for admin users
- Location: tests\AdminSubscriptions.spec.ts:24:7

Error details

Error: expect(locator).toBeVisible() failed

Locator: getByText('Subscription Dashboard')
Expected: visible
Timeout: 5000ms
...
- waiting for getByText('Subscription Dashboard')
