...
- Name: reports.spec.ts >> Reports & Financial Analytics Page Workflows >> prevents export for free plan users and prompts upgrade
- Location: tests\reports.spec.ts:47:7
...
Call log:
  - waiting for getByRole('button', { name: /exportCSV/i })
