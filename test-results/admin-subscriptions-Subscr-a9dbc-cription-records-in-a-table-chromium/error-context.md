...
- Name: admin-subscriptions.spec.ts >> Subscriptions Admin Page >> fetches and renders subscription records in a table
- Location: tests\admin-subscriptions.spec.ts:39:7
