...
- Name: promo-banner.spec.ts >> PromoBanner Component >> navigates when upgrade CTA button is clicked
- Location: tests\promo-banner.spec.ts:25:7
...
Call log:
  - waiting for getByRole('button', { name: /upgradeToPro/i }).first()
