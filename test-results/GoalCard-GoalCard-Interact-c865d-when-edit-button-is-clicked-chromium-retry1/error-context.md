...
- Name: GoalCard.spec.ts >> GoalCard Interactive Workflows >> opens edit modal or triggers action when edit button is clicked
- Location: tests\GoalCard.spec.ts:15:7
...
Call log:
  - waiting for getByRole('button', { name: /editGoal/i })
