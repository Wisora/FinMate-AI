...
- Name: recommendation-card.spec.ts >> RecommendationCard Component Workflows >> renders applied state correctly when recommendation is applied
- Location: tests\recommendation-card.spec.ts:31:7
...
Locator: getByRole('button', { name: /applied/i })
Expected: "true"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /applied/i })
