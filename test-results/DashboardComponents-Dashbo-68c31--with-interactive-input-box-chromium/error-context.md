...
- Name: DashboardComponents.spec.ts >> Dashboard UI Components >> renders AssistantChat with interactive input box
- Location: tests\DashboardComponents.spec.ts:27:7
