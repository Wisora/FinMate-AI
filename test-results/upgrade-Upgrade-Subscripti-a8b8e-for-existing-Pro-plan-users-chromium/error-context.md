...
- Name: upgrade.spec.ts >> Upgrade & Subscription Checkout Workflows >> renders active status badge for existing Pro plan users
- Location: tests\upgrade.spec.ts:52:7
...
Locator: getByText('You have unlocked FinMate Pro Membership!')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('You have unlocked FinMate Pro Membership!')
