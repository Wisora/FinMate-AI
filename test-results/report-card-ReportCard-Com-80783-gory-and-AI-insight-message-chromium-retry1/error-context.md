...
- Name: report-card.spec.ts >> ReportCard Component Workflows >> renders top spending category and AI insight message
- Location: tests\report-card.spec.ts:18:7
...
Locator: getByText(/Top Spending: Housing & Utilities/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Top Spending: Housing & Utilities/i)
